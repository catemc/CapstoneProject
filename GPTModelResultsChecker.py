...
merged.to_csv(
    "C:/Users/catem/OneDrive/Desktop/CapstoneProject/mutation_subtype_phenotype_status.csv",
    index=False
)


# Plot by subtype (Matched / Only GPT / Only FluMutDB)
...
plt.ylabel("Counts")
plt.title("FluMutDB vs GPT-extracted Mutations")
plt.legend()
